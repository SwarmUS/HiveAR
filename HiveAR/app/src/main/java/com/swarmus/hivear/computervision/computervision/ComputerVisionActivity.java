...
package com.swarmus.hivear.computervision.computervision;
...
import com.swarmus.hivear.computervision.common.helpers.FullScreenHelper;
...
public class ComputerVisionActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.fragment_ar_view);
